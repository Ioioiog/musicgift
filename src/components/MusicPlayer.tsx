...
const MusicPlayer = ({ tracks, className }: MusicPlayerProps) => {
  ...
  return (
    <div className={cn("w-full bg-dark-card border border-dark-border/50 rounded-lg p-4", className)}>
      <div className="flex items-center">
        <div className="flex-shrink-0 mr-4">
          <div className={cn("w-16 h-16 rounded bg-primary/20 flex items-center justify-center", 
            currentTrack.coverImage ? "" : "animate-pulse-slow")}>
        ...
        <div className="flex-shrink-0 ml-4 flex items-center space-x-2">
          <Button 
            variant="ghost" 
            size="sm" 
            className="p-1 hover:bg-dark-border/20 rounded-full"
            onClick={toggleMute}
          >
          ...
          <Button 
            variant="ghost" 
            size="sm" 
            className="p-1 w-10 h-10 rounded-full bg-primary text-white hover:bg-primary/90"

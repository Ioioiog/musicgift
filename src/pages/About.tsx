    ...
    <PageContainer>
      ...
      <section className="py-20 px-4 relative overflow-hidden">
        ...
        <div className="container mx-auto text-center max-w-4xl relative z-10">
          ...
          <h1 className="font-mono text-3xl md:text-4xl font-bold text-dark-text mb-6 animate-fade-in dot-matrix">
            Despre Noi
          </h1>
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card className="glass-card p-6 hover-glow">
              <h2 className="text-xl font-mono font-bold mb-4 text-dark-text dot-matrix">Misiunea Noastră</h2>
            ...
            <Card className="glass-card p-6 hover-glow">
              <h2 className="text-xl font-mono font-bold mb-4 text-dark-text dot-matrix">Viziunea Noastră</h2>
              <p className="text-dark-text-muted">
